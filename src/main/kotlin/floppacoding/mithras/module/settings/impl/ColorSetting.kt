...
class ColorSetting(
    ...
    var red: Int
        get() = value.red
        set(input) {
            value = Color(MathHelper.clamp(input,0,255), green, blue, alpha)
        }
    var green: Int
        get() = value.green
        set(input) {
            value = Color(red, MathHelper.clamp(input,0,255), blue, alpha)
        }
    var blue: Int
        get() = value.blue
        set(input) {
            value = Color(red, green, MathHelper.clamp(input,0,255), alpha)
        }
    var hue: Float
        get() {
            updateHSB()
    ...
    var alpha: Int
        ...
        set(input) {
            ...
            value = Color(red, green, blue, MathHelper.clamp(input,0,255))
        }
