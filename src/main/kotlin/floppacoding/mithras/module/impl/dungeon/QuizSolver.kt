...
//            Renderer3D.drawBlockBoundingBox(event.context, it.blockPos.up(), null, Color(20,255,40,150))
    ...
    private val solutions: Map<String,List<String>> = mapOf(
        ...
        "How many total Fairy Souls are there?" to listOf("242 Fairy Souls"),
        ...
        "How many Fairy Souls are there in The Park?" to listOf("11 Fairy Souls"),
        "How many Fairy Souls are there in Jerry's Workshop?" to listOf("5 Fairy Souls"),
        "How many Fairy Souls are there in Hub?" to listOf("79 Fairy Souls"),
        "How many Fairy Souls are there in The Hub?" to listOf("79 Fairy Souls"),
