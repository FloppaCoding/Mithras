...
class UniformMatrix3f : UniformGL<Matrix3f, FloatBuffer> {
    constructor(programID: Int, name: String, updater: () -> Matrix3f) : super(programID, name, Type.FLOAT, 9, updater)
    constructor(programID: Int, name: String): super(programID, name, Type.FLOAT, 9)
