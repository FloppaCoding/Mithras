...
//     */
//    fun drawLine(start: Vec3d, finish: Vec3d, color: Color, thickness: Float = 3f, phase: Boolean = true) {
//        drawLine(start.x, start.y, start.z, finish.x, finish.y, finish.z, color, thickness, phase)
//    }
//
//    /**
...
//        worldRenderer.begin(GL11.GL_LINE_STRIP, VertexFormats.POSITION)
